...
function Page2() {
  ...
  const [singleWordsList, setSingleWordsList] = useState([
    {name: 'Shade', audioFile: '/audio/Shade.wav'},
    {name: 'Shadow', audioFile: '/audio/Shadow.wav'},
    {name: 'Shape', audioFile: '/audio/Shape.wav'},
    {name: 'Shark', audioFile: '/audio/Shark.wav'},
    {name: 'Sharp', audioFile: '/audio/Sharp.wav'},
    {name: 'Shirt', audioFile: '/audio/Shirt.wav'},
    {name: 'Shoe', audioFile: '/audio/Shoe.wav'},
    {name: 'Shop', audioFile: '/audio/Shop.wav'},
    {name: 'Show', audioFile: '/audio/Show.wav'},
    {name: 'Shower', audioFile: '/audio/Shower.wav'},
  ]);
  
    const [longWord, setLongWord] = useState([
      {speed: 1, audioFile: '/audio/Speed21.wav'},
      {speed: 2, audioFile: '/audio/Speed22.wav'},
      {speed: 3, audioFile: '/audio/Speed23.wav'},
    ]);
    ...
    <>
      <div className='page-box'>
        <div className='page' style={{backgroundImage: `url('${process.env.REACT_APP_BASE_URL}images/backgound.png')`}}>
          <h6>Word Family - /<span style={{color: 'black'}}>sh</span>/ words</h6>
        ...
        <div className='page' style={{backgroundImage: `url('${process.env.REACT_APP_BASE_URL}images/backgound.png')`}}>
          <h6><span style={{color: 'red'}}>Sh</span>iro is my pet dog.</h6>
